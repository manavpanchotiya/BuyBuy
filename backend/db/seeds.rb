...
Product.create!(name: "Men's Jacket", description: "Warm and stylish jacket", image
: "https://rab.equipment/media/catalog/product/c/i/cirrus_jacket_army_qip_27_arm.jpg?optimize=medium", price_in_cents: 7500, quantity: 1, swappable: true, category_id: c3.id, user_id: u3.id)
